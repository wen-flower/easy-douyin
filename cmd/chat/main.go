...
import (
	...
	"github.com/wen-flower/easy-douyin/cmd/chat/dal"
	"github.com/wen-flower/easy-douyin/cmd/chat/handler"
	user "github.com/wen-flower/easy-douyin/kitex_gen/chat/chatservice"
...
func run() error {
	...
	svr := user.NewServer(new(handler.ChatServiceImpl),
